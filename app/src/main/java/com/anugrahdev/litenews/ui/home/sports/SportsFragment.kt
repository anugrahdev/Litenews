...
class SportsFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        activity?.toolbar_line?.visibility = View.VISIBLE
        ...
        newsAdapter.setOnItemClickListener {
            ...
            findNavController().navigate(R.id.action_sportsFragment_to_newsDetailActivity,bundle)
        }
        viewModel.getSportsNews(viewModel.country,"sports")
